...
async function translateCookiesUltraSlow() {
  console.log('🐌 Traduction COOKIES ultra lente (10 sec délai)...\n')
  ...
  for (const [lang, code] of Object.entries(langMap)) {
    ...
    for (let i = 1; i <= 11; i++) {
      ...
      const existingContent = json.legal.cookies[sectionKey]?.content
  ...
  console.log('\n\n🎉 Traduction Cookies terminée !')
}

translateCookiesUltraSlow().catch(console.error)
