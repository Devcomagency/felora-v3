  ...
  const features = [
    {
      ...
      description: 'Gérez facilement tous les profils de votre établissement depuis un tableau de bord centralisé.',
      gradient: 'from-violet-500 to-purple-600',
    },
    {
      icon: <Settings className="w-10 h-10" />,
      title: 'Configuration flexible',
      description: 'Personnalisez votre établissement avec vos horaires, tarifs et services spécifiques.',
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl lg:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Gérez votre établissement avec des outils professionnels dédiés
          </p>
        </motion.div>
