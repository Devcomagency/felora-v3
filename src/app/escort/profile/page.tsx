      ...
      <div className="grid gap-6">
        ...
        {false && (
          <div className="space-y-8">
            ...
            {/* Section Préférences Clientèle (tirée de l'ancien onglet preferences) */}
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
        ...
        {false && (
          <div className="space-y-8">
            {/* Section Tarifs */}
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Tarifs & Paiements</h2>
            ...
            {/* Section Localisation & Horaires (intégrée dans Tarifs) */}
            <div className="bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Localisation & Horaires</h2>
        ...
        {/* ANCIEN ONGLET SUPPRIMÉ: Statistiques */}
