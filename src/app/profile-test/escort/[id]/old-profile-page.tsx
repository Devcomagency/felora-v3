// Page de profil escort legacy de V3 (sans le design V2)
export default function OldEscortProfilePage({ id }: { id: string }) {
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center">
      <div className="text-center">
        <h1 className="text-4xl font-bold mb-4">Profil Escort {id}</h1>
        <p className="text-gray-400 mb-8">Version de base (sans design V2)</p>
        <div className="space-y-4">
          <p className="text-sm text-gray-500">
            Pour activer le nouveau design, ajoutez le cookie : FEATURE_UI_PROFILE=true
          </p>
          <button 
            onClick={() => {
